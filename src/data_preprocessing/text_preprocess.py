...
def text_preprocess(input_text: str) -> List[str]:
    """
    Wrapper function for preprocessing: cleans and tokenizes text.
    """
...
if __name__ == "__main__":
    sample_text = "Donald Trump became president of India in 2024. Is this true?"
    print("Processed Tokens:", text_preprocess(sample_text))
